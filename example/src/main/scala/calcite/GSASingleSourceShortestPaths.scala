...
import gelly.examples.data.SingleSourceShortestPathsData
 ...
 * [[gelly.examples.data.SingleSourceShortestPathsData]]
 */
object GSASingleSourceShortestPaths {
  def main(args: Array[String]) {
    ...
    val graph: Graph[Long, Double, Double] = Graph.fromDataSet[Long, Double, Double](edges, new InitVertices(srcVertexId), env)
